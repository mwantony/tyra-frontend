    ...
    <>
      ...
      <div className="container mx-auto px-4 py-16 text-sm max-w-5xl">
        <header className="mb-12 text-center mt-10">
          <h1 className="text-lg font-bold mb-4">Política de Privacidade</h1>
        ...
        <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:prose-invert mx-auto">
          ...
          <section className="mb-12">
            <h2 className="font-bold mb-4">2. Informações que Coletamos</h2>
          ...
          <section className="mb-12">
            <h2 className="font-bold mb-4">3. Como Usamos Suas Informações</h2>
          ...
          <section className="mb-12">
            <h2 className="font-bold mb-4">4. Compartilhamento de Dados</h2>
          ...
          <section className="mb-12">
            <h2 className="font-bold mb-4">8. Alterações nesta Política</h2>
            <p>
